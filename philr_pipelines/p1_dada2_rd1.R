...
saveRDS(taxTab, file.path(home_dir, 'philr_pipelines', "r_objects", "ForwardReads_DADA2_taxonomy.rds"))
saveRDS(alignment, file.path(home_dir, 'philr_pipelines', "r_objects","ForwardReads_DADA2_alignment.rds"))
